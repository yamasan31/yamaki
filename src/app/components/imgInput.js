...
const ImgInput = (props) => {
    ...
    const handleClick = async() => {
        try{
            ...
            data.append("upload_preset", "t6qkl66i")
            data.append("cloud_name","dhhzaidky")
            const response= await fetch("https://api.cloudinary.com/v1_1/dhhzaidky/image/upload", {method: "POST", body: data})
